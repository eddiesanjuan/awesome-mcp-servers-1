...
- [markupr](https://github.com/eddiesanjuan/markupr) - MCP server + desktop app + CLI that captures screenshots, records your screen while you narrate, transcribes with Whisper, and generates AI-ready Markdown with contextual screenshots. Your coding agent can see your screen and act on visual feedback.- <img src="https://static.figma.com/app/icon/1/favicon.ico" height="14" /> [Figma](https://github.com/GLips/Figma-Context-MCP) - Paste a link to your Figma design to get its data in a ready-to-implement format.
